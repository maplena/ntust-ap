...
public class EndPostEventPeopleListAdapter extends RecyclerView.Adapter<EndPostEventPeopleListAdapter.TaskViewHolder>{
    ...
    public EndPostEventPeopleListAdapter(Context context) {
        mContext = context;
    }
     ...
     */
    @Override
    public void onBindViewHolder(EndPostEventPeopleListAdapter.TaskViewHolder holder, int position) {
